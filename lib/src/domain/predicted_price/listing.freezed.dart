    ...
    return _then(_value.copyWith(
      ...
      priceConst: freezed == priceConst
          ...
          : priceConst // ignore: cast_nullable_to_non_nullable
              as double?,
      priceLand: freezed == priceLand
          ? _value.priceLand
          : priceLand // ignore: cast_nullable_to_non_nullable
              as double?,
      rooms: null == rooms
          ? _value.rooms
...
class _$_Listing extends _Listing {
  ...
  @override
  String toString() {
    return 'Listing(m2Land: $m2Land, m2Const: $m2Const, priceConst: $priceConst, priceLand: $priceLand, rooms: $rooms, baths: $baths, cars: $cars, lat: $lat, long: $long, price: $price, modelName: $modelName)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.priceConst, priceConst) ||
                other.priceConst == priceConst) &&
            (identical(other.priceLand, priceLand) ||
                other.priceLand == priceLand) &&
  ...
  int get hashCode => Object.hash(runtimeType, m2Land, m2Const, priceConst,
      priceLand, rooms, baths, cars, lat, long, price, modelName);
