...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i12.SigningBloc>(_i12.SigningBloc(gh<_i9.ISignInFormModel>()));
  gh.factory<_i13.AuthBloc>(() => _i13.AuthBloc(gh<_i3.IAuthDataService>()));
  gh.factory<_i14.IPredictedPriceFacade>(() => _i15.PredictedPriceFacadeImpl(
      predictedPriceForm: gh<_i7.IPredictedPriceForm>()));
  gh.factory<_i16.PredictedPriceBloc>(
      () => _i16.PredictedPriceBloc(gh<_i14.IPredictedPriceFacade>()));
  return getIt;
}
